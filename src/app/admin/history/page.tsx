...
export default async function Home({ searchParams }: { searchParams: { page?: string, limit?: string, name?: string, salaryStatus?: string, dispatchDate?: string } }) {
    ...
    const { data, totalRecords, limit, currentPage } = await fetchHistory(+page, +pageSize, { name, salaryStatus, dispatchDate: dispatchFilter })
    return (
        <>
